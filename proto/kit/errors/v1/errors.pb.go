...
var (
	...
	file_kit_errors_v1_errors_proto_rawDescData []byte
)

func file_kit_errors_v1_errors_proto_rawDescGZIP() []byte {
	file_kit_errors_v1_errors_proto_rawDescOnce.Do(func() {
		file_kit_errors_v1_errors_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kit_errors_v1_errors_proto_rawDesc), len(file_kit_errors_v1_errors_proto_rawDesc)))
	})
