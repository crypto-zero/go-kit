...
func TestGenerateFileUsesDefaultHTTPStreamBinding(t *testing.T) {
	...
	for _, want := range []string{
		...
		`func NewLiveServiceSSEClient(client *sse1.HTTPClient) LiveServiceSSEClient`,
		`func (c *liveServiceSSEClient) Watch(ctx context.Context, in *WatchRequest, opts ...sse1.HTTPStreamCallOption) (*sse.Reader, error)`,
