...
var ErrTxStarted = errors.New("ent_crypto: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("ent_crypto: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.Crypto.Intercept(interceptors...)
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent_crypto: unknown mutation type %T", m)
	}
}
...
func (c *CryptoClient) mutate(ctx context.Context, m *CryptoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent_crypto: unknown Crypto mutation op: %q", m.Op())
	}
}
...
func (c *ExampleClient) mutate(ctx context.Context, m *ExampleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent_crypto: unknown Example mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Crypto, Example []ent.Hook
	}
	inters struct {
		Crypto, Example []ent.Interceptor
	}
)
