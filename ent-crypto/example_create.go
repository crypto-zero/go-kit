...
func (_c *ExampleCreate) SetUsername(v string) *ExampleCreate {
	_c.mutation.SetUsername(v)
	return _c
}

// SetEmail sets the "email" field.
func (_c *ExampleCreate) SetEmail(v string) *ExampleCreate {
	_c.mutation.SetEmail(v)
	return _c
}

// SetPassword sets the "password" field.
func (_c *ExampleCreate) SetPassword(v string) *ExampleCreate {
...
func (_c *ExampleCreate) check() error {
	if _, ok := _c.mutation.Username(); !ok {
		return &ValidationError{Name: "username", err: errors.New(`ent_crypto: missing required field "Example.username"`)}
	}
	...
	if _, ok := _c.mutation.Email(); !ok {
		return &ValidationError{Name: "email", err: errors.New(`ent_crypto: missing required field "Example.email"`)}
	}
	...
	if _, ok := _c.mutation.Password(); !ok {
		return &ValidationError{Name: "password", err: errors.New(`ent_crypto: missing required field "Example.password"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent_crypto: missing required field "Example.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent_crypto: missing required field "Example.updated_at"`)}
	}
	return nil
}
