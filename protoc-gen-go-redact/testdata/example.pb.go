...
const file_testdata_example_proto_rawDesc = "" +
	"\n" +
	"\x16testdata/example.proto\x12\btestdata\x1a\x1akit/redact/v1/redact.proto\"x\n" +
	"\x04User\x12\x12\n" +
	...
	"\x04user\x18\x03 \x01(\v2\x0e.testdata.UserR\x04userB=Z;github.com/crypto-zero/go-kit/protoc-gen-go-redact/testdatab\x06proto3"
...
var file_testdata_example_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
